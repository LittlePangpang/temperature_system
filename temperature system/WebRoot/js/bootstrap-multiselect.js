...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
             ...
             * @returns {String}
             */
            buttonText: function(options, select) {///////////////////text
                ...
                if (options.length === 0) {
                    ...
                    if (options.length > this.numberDisplayed) {
                        ...
                        var selected = '';
                        var ls = this.tSeparatorStr;
                        options.each(function() {
                            var label = ($(this).attr('label') !== undefined) ? $(this).attr('label') : $(this).html();
                            selected += label + ls;
                        });
                        return selected.substr(0, selected.length - this.tSeparatorStr.length) + ' <b class="caret"></b>';
                    }
                }
            },
            /**
             ...
             */
            buttonTitle: function(options, select) {//////////////////value
                if (options.length === 0) {
                    return this.nonSelectedText;
                }
                else {
                    var selected = '';
                    var ls = this.vSeparatorStr;
                    var vPrefStr = this.vPrefStr;
                    var vSuffStr = this.vSuffStr;
                    options.each(function () {
                        selected += vPrefStr + $(this).val() + vSuffStr + ls;
                    });
                    return selected.substr(0, selected.length - this.vSeparatorStr.length);
                }
            },
            /**
             * Create a label.
            ...
            onDropdownShow: function(event) {
                 ...
                 var $button = $multiselect["$button"];
                 var $ul = $multiselect["$ul"];
                 $($container).parent().height($($button).height()+$($ul).height()+20);
            },
            /**
            ...
            buttonWidth: 'auto',
            tSeparatorStr : ', ',//text
            vPrefStr : '',//value Prefix
            vSuffStr : '',//value suffix
            vSeparatorStr : ', ',//value
        ...
        buildDropdownOptions: function() {
            ...
            $('li input', this.$ul).on('change', $.proxy(function(event) {
                ...
                var value = $(event.target).val();//code
